...
CREATE TABLE IF NOT EXISTS transaksi (
    ...
    CONSTRAINT fk_tx_karyawan FOREIGN KEY (id_karyawan) REFERENCES users(id) ON DELETE RESTRICT
) ENGINE=InnoDB;

-- Seed Data (Password default: admin -> admin123, kasir1 -> kasir123)
INSERT INTO users (username, password, role, nama, no_hp) VALUES
('admin', '$2y$10$N2aWWw4TRspSiZWD/jK2k.4fg7SLzlEwRvowpi5FSYDINfT3SICFS', 'admin', 'Owner Umbah', '081234567890'),
